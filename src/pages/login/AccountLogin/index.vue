      ...
      <div class="login-form">
        <a-form :model="formState"
          ...
          <a-form-item label=""
            ...
            <a-row type="flex">
              <a-col flex="200px">
                <a-input v-model:value="formState.identify"
                         placeholder="验证码" />
              </a-col>
              <a-col flex="auto">
          ...
          <a-form-item name="remember"
                       :wrapper-col="{ offset: formCol.labelCol, span: formCol.wrapperCol }">
            <a-checkbox v-model:checked="formState.remember">记住我</a-checkbox>
            <span class="forget-pass"><a href="#">忘记密码？</a></span>
          </a-form-item>

          <a-form-item :wrapper-col="{ offset: formCol.labelCol, span: formCol.wrapperCol }">
        ...
        <div class="login-or-register f-r">
          <a-space>
            <a-button @click="phoneLogin">手机号登录</a-button>
